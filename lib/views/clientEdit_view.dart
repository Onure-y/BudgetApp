...
class ClientEditPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    int index = context.read<AppCubit>().clientIndex;
    return BlocProvider(
        create: (context) => AddClientCubit(userRepository: userRepository)
          ..goToClientEditPage(index),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: Color(int.parse(
                                '0xff' + state.customerModel.containerColor)),
                            ...
                            children: [
                              Icon(
                                  IconHelperPackage.icons[
                                      state.customerModel.customerIconIndex],
                                  size: 48,
                                  color: Colors.white),
                              const SizedBox(
                                height: 10,
                          ...
                          children: [
                            ElevatedButton(
                              onPressed: () {
                                context
                                    .read<AddClientCubit>()
                                    .deleteClientFromDatabase(index);
                                // context
